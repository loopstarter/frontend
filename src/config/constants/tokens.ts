...
export const testnetTokens = defineTokens({
  ...
  lpLoopsBnb: new Token(
    TESTNET,
    '0x0cc7fDA73620791a8e22654C754e5C2e1df976a6',
    18,
    'LP-LOOPS-BNB',
    'LP-LOOPS-BNB',
    'https://loopstarter.com',
  ),
  lpLoopsBusd: new Token(
    TESTNET,
    '0xAcd398DD095706E9b4A51b028e67023232e8D646',
    18,
    'LP-LOOPS-BUSD',
    'LP-LOOPS-BUSD',
    'https://loopstarter.com',
  ...
  btcb: new Token(
    TESTNET,
    '0x5f319004A2378a0ed9b398e102BDda9186AA4242',
    18,
    'BTCB',
    'Binance BTC',
    'https://bitcoin.org/',
  ...
  eth: new Token(
    TESTNET,
    '0x0f51c1691F5dBa6BBF95d9dEdA9Fd0f2AB26015D',
    18,
    'ETH',
    'Binance-Peg Ethereum Token',
    'https://ethereum.org/en/',
