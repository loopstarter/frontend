  ...
  switch (basePath) {
    ...
    case '/info':
      return {
        ...
        description: 'View statistics for Loopstarter exchanges.',
      }
    case '/info/pools':
      return {
    ...
    case '/nfts/activity':
      return {
        title: `${t('Activity')} | ${t('Loopstarter')}`,
      }
    case '/nfts/profile':
      return {
        title: `${t('Profile')} | ${t('Loopstarter')}`,
      }
    case '/pancake-squad':
      return {
        title: `${t('Pancake Squad')} | ${t('Loopstarter')}`,
      }
    default:
      return null
  }
